...
- **E2E Testing** (`e2e_test.py`, `final_e2e_test.py`, `continue_e2e_test.py`, `stream_e2e_test.py`, `browser_e2e_test.py`): End-to-end testing scripts for various scenarios
...
- **UI Screenshot Capture** (`capture_ui_screenshots.py`): Screenshot capture for documentation and demo purposes
